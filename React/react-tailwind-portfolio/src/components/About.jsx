    ...
    <section className="text-gray-700 border-t border-gray-200">
      <div className="container px-5 py-24 mx-auto">
        <div className="text-center mb-20">
          <h1 className="text-2xl sm:text-3xl font-medium mb-2 text-gray-900 dark:text-white">
            About Me
          </h1>
          <p className="pb-10 dark:text-white">
            ...
            <div className="bg-gray-200 rounded-lg p-8">
              ...
              <div>
                <p>
                  ...
                  non dolores necessitatibus, quos quis exercitationem. Tempore
                  aliquid incidunt deserunt voluptatum.
                </p>
